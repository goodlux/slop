...
**No limit on named graphs.** At 250 slops/user × 100 triples/slop:
- 10K users = 250M triples ✅
- 100K users = 2.5B triples ✅ (DBpedia scale)
- 500K users = 12.5B triples ✅ (approaching Wikidata)
...
3. **Spec changes happen:** RDF-star → RDF 1.2 removed quoted triples as subjects. Stay close to stable specs, not cutting edge.
...
**YAGNI meets knowledge graphs.** Ship it. 🚀
